...
// PacketHandler.prototype.message_getOwnersID = function (message) {
//     if (message.length !== 1) {
//         return;
//     }
...
// PacketHandler.prototype.message_getUsersID = function (message) {
//     if (message.length !== 9) {
//         return;
//     }
...
//     this.socket.playerTracker.sendUserID = true;
//     this.socket.playerTracker.userID = reader.readDouble();

//     console.log("message_getUsersID: " + this.socket.playerTracker.userID);
// };
